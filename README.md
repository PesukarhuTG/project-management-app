...
<h2 align="center"><a href="https://project-management-app-pesukathutg.vercel.app/" target="_blank">Deploy link</a></h2>

## Project team

- Tatiana - Frontend developer, Team Lead | [@PesukarhuTG](https://github.com/PesukarhuTG)
- Daria - Frontend developer | [@ipipka](https://github.com/ipipka)
- Sergey - Frontend developer | [@serjml](https://github.com/serjml)
...
https://final-task-backend-production-bfca.up.railway.app/api-docs/
...
- TypeScript
- Axios
- react-intl for localization functionality
